...
const OPTIONS = [
  "Sim, claramente",
  "Sim, mas são pequenas e difíceis de ver",
  "Ainda não percebi nada",
  "Tenho dúvida se algo mudou",
];
...
export default function QuizQuestion4() {
  ...
  function handleContinue() {
    ...
    localStorage.setItem("quiz_q4", OPTIONS[selected]);
    router.push("/quiz/5");
  }
  ...
  return (
    <>
      ...
      <h2 className="mb-8 text-2xl font-bold leading-snug tracking-tight text-black">
        Você consegue perceber mudanças no seu corpo desde que começou?
      </h2>
