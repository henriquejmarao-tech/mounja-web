...
const OPTIONS = [
  "Alta — estou comprometida",
  "Oscilando — tem dias melhores e piores",
  "Baixa — estou me sentindo cansada disso",
  "Muito baixa — estou pensando em desistir",
];
...
export default function QuizQuestion5() {
  ...
  function handleContinue() {
    ...
    localStorage.setItem("quiz_q5", OPTIONS[selected]);
  ...
  return (
    <>
      ...
      <h2 className="mb-8 text-2xl font-bold leading-snug tracking-tight text-black">
        Como está sua motivação com o tratamento hoje?
      </h2>
