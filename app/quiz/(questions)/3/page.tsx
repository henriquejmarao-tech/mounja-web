...
export default function QuizQuestion3() {
  ...
  function handleContinue() {
    ...
    localStorage.setItem("quiz_q3", OPTIONS[selected]);
    router.push("/quiz/marca");
  }
  ...
  return (
    <>
      ...
      <h2 className="mb-8 text-2xl font-bold leading-snug tracking-tight text-black">
        Como você descreveria sua alimentação desde que começou o tratamento?
      </h2>
