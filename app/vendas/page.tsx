...
{/* ── BOTÃO WHATSAPP FLUTUANTE ── */}
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full px-4 py-3 text-sm font-bold text-white shadow-2xl transition hover:scale-105 active:scale-95"
        style={{ backgroundImage: "linear-gradient(to right, #25D366, #128C7E)" }}
      >
